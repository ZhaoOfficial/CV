...
int main()
{
    ...
    parallel_for_(Range(0, mandelbrotImg.rows * mandelbrotImg.cols), [&](const Range& range) {
        ...
        for (int r = range.start; r < range.end; r++)
        {
            i = r / mandelbrotImg.cols;
            j = r % mandelbrotImg.cols;
    ...
    imwrite(storePath + "Mandelbrot_parallel.png", mandelbrotImg);
    imwrite(storePath + "Mandelbrot_sequential.png", mandelbrotImgSequential);
