...
int Drawing_Random_Lines(Mat image, string window_name, RNG rng);
int Drawing_Random_Rectangles(Mat image, string window_name, RNG rng);
int Drawing_Random_Ellipses(Mat image, string window_name, RNG rng);
int Drawing_Random_Polylines(Mat image, string window_name, RNG rng);
int Drawing_Random_Filled_Polygons(Mat image, string window_name, RNG rng);
int Drawing_Random_Circles(Mat image, string window_name, RNG rng);
...
int main()
{
    ...
    string window_name = "Drawing_2 Tutorial";
 ...
 */
int Displaying_Big_End(Mat image, string window_name, RNG)
{
